...
void detectBothEyes(const Mat &face, CascadeClassifier &eyeCascade1,
	                             CascadeClassifier &eyeCascade2, Point &leftEye, Point &rightEye,
...
void equalizeLeftAndRightHalves(Mat &faceImg)
{
    ...
    int midX = w/2;
    Mat leftSide = faceImg(Rect(0,0, midX,h));//inline Mat Mat::operator()( const Rect& roi ) const
	                                                               //     { return Mat(*this, roi); }
...
Mat getPreprocessedFace(Mat &srcImg, int desiredFaceWidth, CascadeClassifier &faceCascade, CascadeClassifier &eyeCascade1, 
	                                   CascadeClassifier &eyeCascade2, bool doLeftAndRightSeparately, Rect *storeFaceRect, Point *storeLeftEye, 
	                                    Point *storeRightEye, Rect *searchedLeftEye, Rect *searchedRightEye)
{
    // Use square faces.
